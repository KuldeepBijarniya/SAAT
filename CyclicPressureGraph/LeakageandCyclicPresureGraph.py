...
class CyclicPressureGraph:
    @staticmethod
    def simulate_atmosphere_exportable_cyclic_pressure(sealed_volume, leakage_coefficient, time_step, total_time, methane_inflow_rate, inert_gas_inflow_rate, inert_gas_purity, air_purity, average_pressure, max_pressure_change, pressure_period, pressure_time_offset, oxygen_depletion_rate, carbon_dioxide_inflow_rate, carbon_dioxide_production_rate, initial_methane, initial_nitrogen, initial_oxygen, initial_CO2):
        ...
        ax2.plot(time, calculate_barometric_pressure(time) / 1e5, label='Barometric Pressure (Pa)', color='g')
